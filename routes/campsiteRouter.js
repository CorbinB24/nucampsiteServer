...
campsiteRouter
  ...
  .put(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Campsite.findById(req.params.campsiteId)
      .then((campsite) => {
        if (campsite && campsite.comments.id(req.params.commentId)) {
          const commentIdAuthor = campsite.comments.id(req.params.commentId)
            .author._id;
  ...
  .delete(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Campsite.findById(req.params.campsiteId)
      .then((campsite) => {
        if (campsite && campsite.comments.id(req.params.commentId)) {
          const commendIdAuthor = campsite.comments.id(req.params.commentId)
            .author._id;
          const userRequestingCommentUpdate = req.user._id;
          if (commentIdAuthor.equals(user.userRequestingCommentUpdate)) {
